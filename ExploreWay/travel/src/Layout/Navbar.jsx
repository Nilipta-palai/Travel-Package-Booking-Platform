...
const Navbar = () => {
    ...
    return (
        ...
        >
            <div className="w-full flex items-center justify-between px-9 py-7 text-yellow-100">
                {/* Logo */}
                ...
                >
                    {role === "Admin" ? (
                        <>
                            ...
                            <Link to="/member" className="hover:underline hover:text-2xl">About</Link>
                ...
                <div className="flex items-center gap-4 relative z-20" ref={dropdownRef}>
                    {isLoggedIn ? (
                        <>
                            ...
                            {dropdownOpen && (
                                <div className="absolute right-0 mt-2 w-44 bg-yellow text-black border rounded-lg shadow-md">
                                    {/* {role === "Admin" ? (
                                        <button
