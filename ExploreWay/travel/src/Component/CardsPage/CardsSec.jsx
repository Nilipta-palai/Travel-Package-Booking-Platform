      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6">
        {filteredData.length > 0 ? (
          filteredData.map((item) => (
            <div
              key={item.id}
              className="bg-gray-100 shadow-md rounded-xl p-4 transition-transform transform hover:scale-105 hover:shadow-lg"
            >
              ...
              <button
                className="mt-3 bg-fuchsia-400 text-black px-4 py-2 rounded-lg hover:bg-fuchsia-600 transition-colors duration-300"
