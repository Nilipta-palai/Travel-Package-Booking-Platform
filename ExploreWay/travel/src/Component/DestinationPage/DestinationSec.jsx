...
const DestinationSec = () => {
  ...
  return (
    <div className='bg-gradient-to-b bg-slate-100 backdrop-blur-md rounded-lg shadow-md p-4'>
      ...
      <div className='flex flex-col md:flex-row justify-center gap-4 md:gap-8 items-center mb-6'>
        <div className='relative bg-yellow-300 flex items-center rounded-3xl w-full md:w-60 px-3 py-2'>
        ...
        <button
          className='bg-yellow-500 text-gray-black flex items-center justify-center rounded-3xl w-full md:w-40 px-4 py-2 hover:bg-orange-500 transition'
        >
      ...
      <div className='flex justify-center flex-wrap gap-4 mb-8'>
        {['all', 'beach', 'garden', 'historical', 'cultural', 'spiritual', 'mountains', 'island'].map(category => (
          <button
            key={category}
            className={`px-4 py-2 rounded-3xl font-medium transition ${filter === category ? 'bg-yellow-500 text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
              ...
              >
                ...
                <div className="flex flex-col flex-1 p-4">
                  ...
                  <p className="text-sm text-gray-600 mb-2 line-clamp-1">
                    <FaLocationDot className="inline text-yellow-500 mr-1" />
                    {item.location}
                  </p>
  ...
  <button
    ...
    className="bg-yellow-200 text-black px-4 py-2 rounded-md text-sm font-medium hover:bg-yellow-600 transition"
  >
    Explore Now
  </button>
