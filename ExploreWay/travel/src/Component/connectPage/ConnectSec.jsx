...
const ConnectSec = () => {
  ...
  return (
    <div className='flex flex-col md:flex-row justify-evenly items-center h-auto md:h-[38rem] p-8 gap-10 bg-gradient-to-b bg-gray-100 rounded-lg shadow-lg'>
      ...
      <div className='flex flex-col h-auto justify-evenly items-center md:items-start text-center md:text-left max-w-md space-y-4'>
        ...
        <Link
          to="/login"
          className='mt-4 py-3 w-[13rem] bg-yellow-500 h-[3rem] rounded-3xl font-semibold text-white tracking-wider text-center hover:bg-orange-600 transition duration-300'
        >
          Start Here
        </Link>
      </div>
