...
const EditSec = () => {
  ...
  const validateForm = () => {
    ...
    if (!description || getWordCount(description) < 20) {
    ...
    // More Details (extraInfo): At least 100 words
    if (!extraInfo || getWordCount(extraInfo) < 100) {
      newErrors.extraInfo = "Please provide at least 100 words in more details.";
    }
  ...
  return (
    <div className="mt-24 flex justify-center items-start px-6 py-8 bg-gray-200 min-h-screen w-[95%] mx-auto rounded-lg shadow-sm">
      <div className="card lg:flex bg-base-100 shadow-md w-full h-full p-6 flex flex-col lg:flex-row overflow-hidden space-x-6">
        ...
        <div className="card-body flex-1 overflow-auto">
          <h2 className="card-title text-2xl font-semibold text-black">Edit Story</h2>
          <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
            ...
            <div className="flex flex-col">
              <label className="text-black font-bold">Upload New Image:</label>
              <input
                type="file"
            ...
            <div className="flex flex-col">
              <label className="text-black font-bold">Ratings:</label>
              <input
                type="number"
                step="0.1"
                max="5"
            ...
            <div className="flex flex-col">
              <label className="text-black font-bold">More Details:</label>
              <textarea
                className="textarea textarea-bordered h-24 rounded-xl border-black border-2"
                value={extraInfo}
            ...
            <div className="card-actions flex justify-evenly items-center mt-4">
              <button
                type="submit"
                className="btn btn-primary bg-orange-600 text-black w-[10rem] h-[3rem] rounded-2xl"
                disabled={loading}
              >
              ...
              <button
                type="button"
                className="btn btn-secondary bg-orange-600 text-black w-[10rem] h-[3rem] rounded-2xl"
