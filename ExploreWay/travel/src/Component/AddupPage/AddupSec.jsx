...
const AddupSec = () => {
  ...
  const validateForm = () => {
    const alphabetRegex = /^[a-zA-Z\s\-–'.,()]{1,}$/;
;
;
    ...
    if (descriptionWords.length < 2) {
      toast.error("Description must contain at least  words.");
      return false;
    }
    ...
    if (!extraInfo.trim() || wordCount < 50) {
      toast.error("More Details must contain at least 50 words.");
      return false;
    }
