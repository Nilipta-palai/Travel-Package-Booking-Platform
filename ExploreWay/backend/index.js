...
const allowedOrigins = [
  "http://localhost:5173",
  "https://travel-package-booking-platform.onrender.com"
];
...
app.use(express.static(path.join(__dirname,'/travel/dist')))


app.get('*',function(req,res){
  res.sendFile(path.resolve(__dirname,"travel","dist","index.html"));
})
