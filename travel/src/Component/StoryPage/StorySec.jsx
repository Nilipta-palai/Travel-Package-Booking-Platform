  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center min-h-screen bg-gray-100 p-8 mt-12">
      ...
      <div className="w-full md:w-1/2 shadow-lg rounded-lg p-6 md:ml-6 mt-6 md:mt-0 flex flex-col h-full transform transition-transform duration-300">
        ...
        <p className="text-gray-600 mt-2"><strong>Location:</strong> {destination.location || "Not Available"}</p>
        <p className="text-gray-600 mt-2"><strong>Price Per Night:</strong> ${destination.night || "N/A"}</p>
        <p className="text-gray-600 mt-2"><strong>Rating:</strong> ⭐ {destination.ratings || "No Ratings"}</p>
